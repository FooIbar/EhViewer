            ...
            container = {
                val containerColor =
                    animateColorAsState(
                        ...
                        animationSpec = rememberFastEffectsSpec(),
...
// TODO: Remove after updating to snapshot 12152755
@Composable
private fun inputFieldColors() = SearchBarDefaults.inputFieldColors().copy(
...
@Composable
private inline fun <reified T> rememberFastEffectsSpec() = remember(T::class) {
    spring<T>(dampingRatio = Spring.DampingRatioNoBouncy, stiffness = 3800f)
}
