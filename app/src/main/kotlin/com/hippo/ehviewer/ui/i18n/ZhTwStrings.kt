...
val ZhTwStrings = Strings(
    ...
    duplicateQuickSearch = { a: String -> "已存在相同的快速搜尋，名稱為“$a”。" },
    duplicateName = "名稱重複",
    saveProgress = "儲存進度",
    deleteQuickSearch = { a: String -> "刪除快速搜尋“$a”？" },
    ...
    filterTheUploader = { a: String -> "把上傳者“$a”加入過濾列表？" },
    filterTheTag = { a: String -> "隱藏標籤“$a”？" },
    filterAdded = "已經新增篩選條件",
    newerVersionAvailable = "此圖庫有新版本可以使用。",
    newerVersionTitle = { a: String, b: String -> "$a, 於 $b 加入" },
    rating10 = "太神啦！",
    rating9 = "根本把持不住",
    rating8 = "很棒",
    rating7 = "不錯",
    ...
    filterTheCommenter = { a: String -> "隱藏評論者“$a”？" },
    editComment = "修改留言",
    ...
    goTo = "跳到",
    sceneDownloadTitle = { a: String -> "正在下載 - $a" },
    ...
    downloadStateFailed2 = { a: Int -> "還有 $a 未完成" },
    downloadStateFinish = "大功告成",
    stat509AlertTitle = "509 警告",
    stat509AlertText = "圖片流量已用盡。請停止下載，休息一下。",
    statDownloadDoneTitle = "下載結束",
    statDownloadDoneTextSucceeded = { a: Int -> "有 $a 項已成功下載" },
    statDownloadDoneTextFailed = { a: Int -> "有 $a 項下載失敗" },
    statDownloadDoneTextMix = { a: Int, b: Int -> "$a 項成功下載，$b 項下載失敗" },
    statDownloadDoneLineSucceeded = { a: String -> "$a 下載成功" },
    statDownloadDoneLineFailed = { a: String -> "$a 下載失敗" },
    downloadRemoveDialogTitle = "移除下載佇列",
    downloadRemoveDialogMessage = { a: String -> "將 $a 從下載佇列中移除嗎？" },
    downloadRemoveDialogMessage2 = { a: Int -> "從下載佇列中移除 $a 項任務嗎？" },
    ...
    settingsDownloadReloadMetadataSuccessfully = { a: Int -> "成功載入 $a 項" },
    settingsDownloadReloadMetadataFailed = { a: String -> "載入中繼資料失敗: $a" },
    ...
    settingsDownloadRestoreSuccessfully = { a: Int -> "成功復原 $a 項" },
    ...
    settingsDownloadCleanRedundancyDone = { a: Int -> "完成冗餘檔案清理，共清理了 $a 個檔案" },
    settingsAdvanced = "進階",
    ...
    settingsAdvancedDumpLogcatTo = { a: String -> "已將紀錄檔儲存至 $a" },
    ...
    settingsAdvancedExportDataTo = { a: String -> "已匯出資料至 $a" },
    ...
    settingsAdvancedBackupFavoriteStart = { a: String -> "正在備份收藏列表 $a" },
    ...
    settingsAboutCommitTime = { a: String -> "於 $a 提交" },
    ...
    settingsDownloadDownloadDelaySummary = { a: Int -> "每次下載延時 $a 毫秒" },
    ...
    deleteSearchHistory = { a: String -> "從搜尋記錄中刪除“$a”？" },
    actionAddTag = "增加標籤",
    actionAddTagTip = "增加新標籤",
    commentUserUploader = { a: String -> "$a （上傳者）" },
    settingsEhMeteredNetworkWarning = "流量計費網路警告",
    meteredNetworkWarning = "正在使用流量計費網路",
    readFrom = { a: Int -> "從第 $a 頁閱讀" },
    ...
    settingsPrivacyRequireUnlockDelaySummary = { a: Int -> "離開程式並在 $a 分鐘內返回時不需要解鎖" },
