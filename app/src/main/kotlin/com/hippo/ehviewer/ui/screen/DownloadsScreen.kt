...
@Composable
fun AnimatedVisibilityScope.DownloadsScreen(navigator: DestinationsNavigator, backStackEntry: NavBackStackEntry) = composing(navigator) {
    ...
    SearchBarScreen(
        ...
        Crossfade(targetState = gridView, label = "Downloads") { showGridView ->
            if (showGridView) {
                ...
                val origin = backStackEntry.id + "-grid"
                FastScrollLazyVerticalStaggeredGrid(
                    ...
                    items(list, key = { it.gid }) { info ->
                        GalleryInfoGridItem(
                            ...
                            onLongClick = { navigate(info.galleryInfo.asDst(origin)) },
                            info = info,
                            origin = origin,
                ...
                val origin = backStackEntry.id + "-list"
                    ...
                    items(list, key = { it.gid }) { info ->
                        ...
                        CheckableItem(
                            ...
                            DownloadCard(
                                ...
                                onThumbClick = {
                                    navigate(info.galleryInfo.asDst(origin))
                                },
                                onLongClick = {
                                    checkedInfoMap[info.gid] = info
                                },
