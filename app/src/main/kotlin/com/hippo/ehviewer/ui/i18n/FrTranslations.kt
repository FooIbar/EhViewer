...
object FrTranslations : Translations by EnTranslations {
    ...
    override val invalidDownloadLocation =
        "La location de téléchargement actuelle n\'est pas disponible. Choissez-en une à nouveau dans les Paramétres."
    ...
    override val appWaring =
        "Le contenu de l\'application provient de l\'Internet, dont quelque chose peut vous causer le dommage physique ou mentale. Vous l\'avez bien compris et voulez continuer quand même."
    ...
    override val galleryListEmptyHitSubscription =
        "Vous pouvez suivre des tags à Paramètres -> EH -> Mes tags."
    ...
    override val addQuickSearchTip =
        "Le resultat de la liste de galerie sera sauvegardé comme une Recherche rapide. Cherchez d\'abord pour sauvegarder l\'état du panneau recherche."
    override val readme = "README"
    override val imageSearchNotQuickSearch =
        "Impossible d\'ajouter recherche d\'une image comme une Recherche rapide."
    override val duplicateQuickSearch = { p0: String ->
        "Une Recherche rapide avec le nom \"%s\" déjà existe."
            .format(p0)
    }
    override val duplicateName = "Ce nom déjà existe"
    override val goToHint = { p0: Int, p1: Int ->
        "Page %d, avec un totale de %d pages"
            .format(p0, p1)
    }
    ...
    override val stat509AlertText =
        "Votre limite d\'obtention d\'images est atteinte. Arrêtez le téléchargement et réessayez plus tard."
    ...
    override val downloadRemoveDialogMessage = { p0: String ->
        "Retirer %s de la liste de téléchargement ?"
            .format(p0)
    }
    override val downloadRemoveDialogMessage2 = { p0: Int ->
        "Retirer %d articles de la liste de téléchargement ?"
            .format(p0)
    }
    ...
    override val resetReadingProgressMessage =
        "Réinitialiser les progrès de lecture de toutes galéries téléchargées ?"
    ...
    override val deleteFilter = { p0: String ->
        "Supprimer le bloqueur bloqueur \"%s\" ?"
            .format(p0)
    }
    ...
    override val settingsEhFilterSummary =
        "Filtrer les galerie par les titres, les uploaders ou les tags"
    ...
    override val settingsDownloadCantGetDownloadLocation =
        "Impossible d\'obtenir la destination de téléchargement"
    override val settingsDownloadMediaScan = "Permettre le scannage multimédia"
    override val settingsDownloadMediaScanSummaryOn =
        "Ne montrez jamais vos applications galerie à personne"
    override val settingsDownloadMediaScanSummaryOff =
        "La plupart d\'applications galerie ignorent les images dans le chemin de téléchargement"
    ...
    override val settingsDownloadPreloadImageSummary = { p0: String ->
        "Charger les prochaine %s images"
            .format(p0)
    }
    ...
    override val settingsDownloadDownloadOriginImageSummary =
        "Vous allez obtenir l\'erreur 509 plus facilement"
    ...
    override val settingsDownloadRestoreDownloadItemsSummary =
        "Rétablir tous objets déjà téléchargés dans la destination de téléchargement"
    ...
    override val settingsDownloadCleanRedundancySummary =
        "Effacer les fiches des galeries qui ne sont pas dans la liste de téléchargement mais se trouvent dans la destination de téléchargement"
    ...
    override val settingsDownloadCleanRedundancyDone = { p0: Int ->
        "Nettoyage complété avec succès, %d objets effacés"
            .format(p0)
    }
    ...
    override val settingsAdvancedExportDataSummary =
        "Sauvegarder les données au stockage externe, y compris la liste de téléchargement, la liste de recherche rapide"
    override val settingsAdvancedExportDataTo = { p0: String ->
        "Données exportées à %s"
            .format(p0)
    }
    ...
    override val settingsAboutDeclarationSummary =
        "EhViewer ne s\'affilie à E-Hentai de aucune manière."
    ...
    override val settingsPrivacySecureSummary =
        "Quand cette option est activée, vous ne pouvez prendre aucune capture d\'écran de l\'application, et le systéme n\'affiche pas le contenu d\'écran dans le sélecteur de tâches.\n\nRedémarrage de l\'application est nécessaire pour appliquer le changement"
    ...
    override val settingsEhIdentityCookiesSigned =
        "Tout le monde peut utiliser les cookies de ce compte pour s\'y connecter.<br><b>GARDEZ-LES BIEN !</b>"
    ...
    override val settingsEhShowGalleryPagesSummary =
        "Montrer le nombre des pages des galerie dans la liste des galeries"
    ...
    override val someMinutesAgo = { quantity: Int ->
        when (quantity) {
            1 -> "Il y a %d minute"
            else -> "Il y a %d minutes"
        }.format(quantity)
    }
    override val someHoursAgo = { quantity: Int ->
        when (quantity) {
            1 -> "Il y a %d heure"
            else -> "Il y a %d heures"
        }.format(quantity)
    }
