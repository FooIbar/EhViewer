...
object DeTranslations : Translations by EnTranslations {
    ...
    override val downloadRemoveDialogMessage = { p0: String ->
        "%s aus der Downloadliste entfernen?"
            .format(p0)
    }
    override val downloadRemoveDialogMessage2 = { p0: Int ->
        "%d Downloads aus der Downloadliste entfernen?"
            .format(p0)
    }
    ...
    override val imageSaved = { p0: String ->
        "Das Bild wurde zu %s gespeichert"
            .format(p0)
    }
    ...
    override val settingsEhFilterSummary =
        "Nach Titel, Uploader order Etiketten die unerwünschten Galerien verstecken"
    ...
    override val settingsDownloadCantGetDownloadLocation =
        "Downloadziel konnte nicht geladen werden"
    ...
    override val settingsDownloadMediaScanSummaryOff =
        "Meisten Galerie-Apps ignorieren die Bilder im Downloadpfad"
    ...
    override val settingsDownloadPreloadImageSummary = { p0: String ->
        "Die nächste %s Bilder vorabladen"
            .format(p0)
    }
    ...
    override val settingsDownloadDownloadOriginImageSummary =
        "Wenn es aktiviert wird, wird der 509-Fehler dir schneller widerfahren"
    ...
    override val settingsDownloadRestoreDownloadItemsSummary =
        "Alle Download-Elemente im Downloadpfad wiederherstellen"
    ...
    override val settingsDownloadCleanRedundancyNoRedundancy =
        "Keine zu löschenden Dateien gefunden"
    override val settingsDownloadCleanRedundancyDone = { p0: Int ->
        "Reinigung abgeschlossen. %d Datei(en) wurde(n) gelöscht."
            .format(p0)
    }
    ...
    override val deleteFavoritesDialogMessage = { p0: Int ->
        "%d Elemente aus Favoriten löschen?"
            .format(p0)
    }
    ...
    override val downloadArchiveFailureNoHath =
        "H@H-Klient ist für das Herunterladen der Archivdateien erforderlich"
    ...
    override val settingsPrivacySecureSummary =
        "Screenshots werden verhindert. Inhalt der App wird in Aktuelle Apps-Liste nicht angezeigt."
    override val appWaring =
        "Inhalt dieser App kommt aus dem Internet, von dem einige dir körperlichen oder emotionalen Schaden zufügen kann. Du hast es wirklich erfahrt und möchtest immer noch fortsetzen."
    ...
    override val clipboardGalleryUrlSnackMessage =
        "Ein Link von einen Galerie wurde in Zwischenablage erkennt."
    ...
    override val settingsAboutDeclarationSummary =
        "EhViewer verbindet sich in keiner Weise mit E-Hentai.org."
    ...
    override val settingsAdvancedExportDataSummary =
        "Daten, z. B. Downloadliste, Sofortsucheliste, zum externen Speicher speichern"
    override val settingsAdvancedExportDataTo = { p0: String ->
        "Daten wurden zu %s exportiert"
            .format(p0)
    }
    ...
    override val resetReadingProgressMessage =
        "Lesefortschritte aus allen heruntergeladenen Galerie zurücksetzen?"
    override val settingsEhIdentityCookiesSigned =
        "Wenn jemand die folgenden Informationen hat, kann er sich als du anmelden. <br><b>ALSO GEHEIM HALTEN!</b>"
    ...
    override val settingsEhShowGalleryPagesSummary =
        "Die Galerieseitenzahle in der Galerieliste anzeigen"
