...
object DeTranslations : Translations by EnTranslations {
    ...
    override val duplicateQuickSearch = { p0: String ->
        "Eine Sofortsuche, deren Name ist %s, bereits besteht."
            .format(p0)
    }
    ...
    override val filterTheUploader = { p0: String ->
        "Uploader \"%s\" blockieren?"
            .format(p0)
    }

    override val filterTheTag = { p0: String ->
        "Etikett \"%s\" blockieren?"
            .format(p0)
    }
    ...
    override val downloadStateFailed2 = { p0: Int ->
        "%d wurde noch nicht abgeschlossen"
            .format(p0)
    }
    ...
    override val statDownloadDoneTextSucceeded = { p0: Int ->
        "%d Download(s) wurde(n) abgeschlossen"
            .format(p0)
    }

    override val statDownloadDoneTextFailed = { p0: Int ->
        "%d Download(s) gescheitert"
            .format(p0)
    }

    override val statDownloadDoneTextMix = { p0: Int, p1: Int ->
        "%d erfolgreich abgeschlossen, %d gescheitert"
            .format(p0, p1)
    }
